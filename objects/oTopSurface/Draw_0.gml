if(surface_exists(shaderSurface)) {
	...
	draw_surface_part_ext(shaderSurface,
		0,oPlayer.y-camera_get_view_y(view_camera[0]),
		camera_get_view_width(view_camera[0]),
		camera_get_view_height(view_camera[0])/2-(oPlayer.y-camera_get_view_y(view_camera[0])-camera_get_view_height(view_camera[0])/2),
